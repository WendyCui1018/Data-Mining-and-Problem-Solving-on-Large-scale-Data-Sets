...
png(filename="./2_1_a_network_1000.png")
plot(g, main="2_1_a_network_1000", vertex.size=2, vertex.label=NA, edge.arrow.size=1)
print(diameter(g))
...
png(filename="./2_1_c_graph_degree.png")
hist(degree(g), breaks=0:25, main="degree distribution of graph", xlab = "degree", ylab = "frequency")
png(filename="./2_1_c_end_nodes_degree.png")
hist(degree(g, end_ids), breaks=0:25, main="degree distribution of the end nodes reached", xlab = "degree", ylab = "frequency")

print("finished 2.1(c)")
# 2.1(d)
# 100
p = 0.01
n = 100
g <- random.graph.game(n, p, directed=FALSE)
t_matrix = create_transition_matrix(g)
png(filename="./2_1_d_network_100.png")
plot(g, main="2_1_d_network_100", vertex.size=2, vertex.label=NA, edge.arrow.size=1)
print(diameter(g))
...
t_matrix = create_transition_matrix(g)
png(filename="./2_1_d_network_10000.png")
plot(g, main="2_1_d_network_10000", vertex.size=2, vertex.label=NA, edge.arrow.size=1)
print(diameter(g))
